...
import stanfordnlp.jsonrpc
# import stanfordnlp.pexpect
import pexpect
import subprocess
from stanfordnlp.progressbar import ProgressBar, Fraction
...
def parse_parser_results_new(text):
    ...
    # MJ code to strip away extra newlines
    seqs = [i for i in seqs if i.strip()]
    # seqs = [''] + seqs # Add in the intial value to follow convention
...
class StanfordCoreNLP(object):
    ...
    def setup(self):
        ...
        # self.corenlp = stanfordnlp.pexpect.spawn(start_corenlp)
...
#        pbar.update(5)
    ...
    def _parse(self, text):
        ...
        while True:
            ...
            try:
                incoming += self.corenlp.read_nonblocking(40000, 1800).decode()
            ...
            # except stanfordnlp.pexpect.TIMEOUT:
                if end_time - time.time() < 0:
                    ...
                    continue
            # except stanfordnlp.pexpect.EOF:
            except pexpect.EOF:
                break
